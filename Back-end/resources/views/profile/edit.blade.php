            ...
            <div class="navbar-content">
                ...
                <div class="user-actions">
                    <a href="{{ route('profile.edit') }}">
                        <img src="{{ Auth::user()->imagemPerfil ? asset('storage/' . Auth::user()->imagemPerfil).'?v='.time() : asset('assets/img/user-icon.png') }}" 
                    ...
                    <form method="POST" action="{{ route('logout') }}" style="display: inline; margin-left: 10px;">
                        @csrf
                        <button type="submit" class="perfilLojista" style="background: none; border: none; color: white; cursor: pointer; font: inherit; font-size: 1rem;">
                            Sair
                        </button>
                    </form>
                </div>
